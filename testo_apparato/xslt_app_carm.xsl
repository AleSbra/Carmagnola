        ...
        <xsl:for-each select="tei:p/tei:app | tei:head/tei:app">
            <xsl:result-document href="puliti/{$crapp}/{tei:lem/@n}.html">
                <html>
                    ...
                    <body>
                        <header>
                            <h1 class="titolo">Dal <i>Fermo e Lucia</i> agli <i>Sposi
                                Promessi</i></h1>
                        </header>
                        <div class="title">
                        ...
                        <div class="container">
                            ...
                            <h3>
                                <xsl:if
                                    test="preceding::tei:lem[ancestor::tei:text/@xml:id = $current-text][parent::tei:app[parent::tei:p | parent::tei:head]][1][@n]">
                                    <a
                                ...
                                <xsl:if
                                    test="following::tei:lem[1][@n][ancestor::tei:text/@xml:id = $current-text]">
                                    <a
                                        href="{following::tei:lem[1][@n][ancestor::tei:text/@xml:id = $current-text]/@n}.html"
                                        > >></a>
                                </xsl:if>
